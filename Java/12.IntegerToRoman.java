...
class Solution {
    public String intToRoman(int num) {
        ...
        String[] milis  = new String[]{"", "M", "MM", "MMM"};
        String[] centis = new String[]{"", "C", "CC", "CCC", "CD", "D", "DC", "DCC", "DCCC", "CM"};
        String[] decis  = new String[]{"", "X", "XX", "XXX", "XL", "L", "LX", "LXX", "LXXX", "XC"};
        String[] units  = new String[]{"", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX"};
        
        return milis[num / 1000 % 10] + centis[num / 100 % 10] + decis[num / 10 % 10] + units[num % 10];
    }
}